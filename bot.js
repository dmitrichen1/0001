    ...
    if (calcMatch) {
      try {
        ...
        if (est.error) {
          ...
          let priceStr;
          if (est.priceFrom) {
            // камень не выбран — цена "от" по самому дешёвому
          ...
          if (MANAGER_CHAT_ID) {
            ...
            const stoneNote = est.priceFrom ? `\nКамень: ${est.usedStone} (цена ОТ, клиент не выбрал)` : '';
